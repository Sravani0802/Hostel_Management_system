...
<body>
	...
	<div class="container">
		<button class="btn"><a href="ad-web.php">Home</a></button>
		...
		<button class="btn"><a href="view-stu-ad.php">Add & edit Student Details</a></button>
		<button class="btn"><a href="view-reg.php">View Registrations</a></button>
		<button class="btn"><a href="view-emp-ad.php">Add & View employee</a></button>
		<button class="btn"><a href="view-fee.php">View Fee Details</a></button>
	</div>
</body>
</html>
